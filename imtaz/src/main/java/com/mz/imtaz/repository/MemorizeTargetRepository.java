...
public interface MemorizeTargetRepository extends JpaRepository<MemorizeTarget, Integer>{
	...
	@Query("Select a from MemorizeTarget a where a.records.classRoomDetail = :classRoomDetail and a.records.student = :student order by a.records.student.name asc")
